...
import { Engine, Scene, ArcRotateCamera, Vector3, HemisphericLight, MeshBuilder, Color4, Color3 } from "@babylonjs/core";
...
class App {
    constructor() {
        ...
        var camera = new ArcRotateCamera("Camera", Math.PI / 2, Math.PI / 2, 25, new Vector3(5, 5, 5), scene);
        ...
        var ground = MeshBuilder.CreateGround("ground", { width: 11, height: 11 });
        ground.position = new Vector3(5, 0.5, 5);
        ground.material = Grid();
        var side1 = MeshBuilder.CreatePlane("side1", { width: 11, height: 11 });
        side1.rotation.y = Math.PI / 2;
        side1.position = new Vector3(10.5, 6, 5);
        side1.material = Grid();
        var side2 = MeshBuilder.CreatePlane("side2", { width: 11, height: 11 });
        side2.rotation.y = -Math.PI / 2;
        side2.position = new Vector3(-0.5, 6, 5);
        side2.material = Grid();
        var side3 = MeshBuilder.CreatePlane("side3", { width: 11, height: 11 });
        side3.position = new Vector3(5, 6, 10.5);
        side3.material = Grid();
        var side4 = MeshBuilder.CreatePlane("side4", { width: 11, height: 11 });
